	...
	public RegistroHuesped() {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Guadar guadar = new Guadar();

			    // Obtener los valores de los campos
			    String nombre = txtNombre.getText();
			    String apellido = txtApellido.getText();
			    java.util.Date fechaSeleccionada = txtFechaN.getDate();
			    SimpleDateFormat formatoFecha = new SimpleDateFormat("dd/MM/yyyy"); // Formato deseado
			    String fechaSeleccionadaStr = formatoFecha.format(fechaSeleccionada); // Formatear la fecha a una cadena
			    ...
			    Map<String, String> registroHuesped = new HashMap<>();
			    registroHuesped.put("NOMBRE", nombre);
			    registroHuesped.put("APELLIDO", apellido);
			    registroHuesped.put("FECHA", fechaSeleccionadaStr);
			    registroHuesped.put("NACIONALIDAD", nacionalidad);
			    registroHuesped.put("TELEFONO", telefono);
			    registroHuesped.put("RESERVA", reserva);

			    try {
			    	guadar.ejecutarGuardar(nombre, apellido, fechaSeleccionadaStr, nacionalidad, telefono, reserva);
				...
				System.out.println("Haz presionado el boton");
			}
		});
