	...
	public RegistroHuesped() {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int insertarDatos = 0;
				try {
					int datosTabla = ObtenerPosicion.datosPosicion();
					insertarDatos = datosTabla++;
			    ...
			    try {
			    	guadar.ejecutarGuardar(nombre, apellido, fechaSeleccionadaStr, nacionalidad, telefono, insertarDatos);
			    	Exito.main(null);
			    } catch (SQLException e1) {
